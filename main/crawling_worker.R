# -*- coding: utf-8 -*-
# Created by jianhonglindst at 2018/10/28

# (version 2.0.0) download mi_index json file by day
...
main <- function() {
    ...
    end_date = ifelse(test = arguments$end_date == "now_date", yes = as.character(date(now()) - 1), no = arguments$end_date)
